...
# RUN 1:
# Try two different variations of augmented model training (with and without residual covariance updates):
recipe.start_stage = 2
ivector.type = ['augmented']
ivector.update_covariances = [False, True]
...
# RUN 2:
# Try four parameter combinations [residual updates (True/False) and minimum_divergence (True/False)] with standard formulation:
recipe.start_stage = 2
